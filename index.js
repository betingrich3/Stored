...
console.log('Plugins Installation Successful')
console.log('Bugatti Connected')
...
//================ownerreact==============
if(senderNumber.includes("2547490375710")){
if(isReact) return
m.react("")
}
...
app.get("/", (req, res) => {
res.send("Hello, Bugatti is connected Enjoy");
});
